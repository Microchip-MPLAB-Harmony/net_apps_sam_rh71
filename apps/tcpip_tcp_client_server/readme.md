...
**TCP/IP TCP Client Server MCC Configuration**
...
3.  Execution :
    ...
    1.  After the successful board bring up, the console output becomes
        ...
        ![tcpip_tcp_client_server_project](../../docs/GUID-C62B1214-1B85-4E27-89B5-E783E905D246-low.png)
    ...
    2.  For TCP Client test, input the following command from the serial port: **openurl < url \>** - The < url \> argument must be a fully formed URL; for instance, "http://www.microchip.com/".
        ...
        ![tcpip_tcp_client_server_project](../../docs/GUID-65FFC3F7-0B2F-4739-AEC9-08826C7EDAD0-low.png)
